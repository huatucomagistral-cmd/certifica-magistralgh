      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        {loading ? (
          ...
          <div className="p-14 text-center flex flex-col items-center">
            ...
            <Link
              href="/admin/dashboard/templates/nuevo"
              className="mt-6 inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-[#02367B] bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors"
            >
              <Plus className="w-4 h-4" />
                        ...
                        {renamingId === template.id ? (
                          <div className="flex items-center gap-1.5">
                            <input
                              ...
                              className="border border-[#02367B] rounded-lg px-2.5 py-1 text-sm font-semibold text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#02367B]/20 w-44"
                              disabled={savingName}
                            />
                          ...
                          <div className="flex items-center gap-1.5 group/name">
                            ...
                            <button onClick={() => startRename(template)}
                              className="opacity-0 group-hover/name:opacity-100 p-1 text-slate-300 hover:text-[#02367B] hover:bg-blue-50 rounded-md transition-all" title="Renombrar">
